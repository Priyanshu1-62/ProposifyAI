  ...
  return (
    ...
    {sidebar && <div className="w-60 h-[93.4vh] py-2 px-2 border-r border-gray-300">
      <ul className="flex flex-col gap-2 mt-2 text-sm text-gray-800">
        <li>
          <button className="w-full flex gap-2 items-center px-2 py-2 hover:bg-gray-300 hover:cursor-pointer rounded-xl" onClick={()=>{navigate("/request/title")}}><FaPlus size={18}/> Create Request</button>
        </li>
        <li>
